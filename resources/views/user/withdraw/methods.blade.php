...
@section('content')
    <section class="featured-area pd-top-98 pd-bottom-70">
        <div class="container">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="single-analysis-wrap text-center">
                                        <div class="thumb">
                                            <img src="{{asset('images/withdraw_methods')}}/{{$gate->image}}" alt="img">
                                        </div>
                                        <div class="wrap-details">
                                            <h5><a href="#depositModal{{$gate->id}}" data-toggle="modal">{{__($gate->name)}}</a></h5>
                            
                                        </div>
                                        <div class="wrap-price">
                                            <a class="btn btn-base" href="#depositModal{{$gate->id}}" data-toggle="modal"><i class="fa fa-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">{{__('Withdraw via')}} <strong>{{__($gate->name)}}</strong></h4>
