...
@section('content')
    ...
    <div class="check-profit-area pd-top-100 pd-bottom-90">
        <div class="container">
            <div class="row justify-content-left">
                ...
                @else
                    <form>
                        ...
                        <button type="button" class="btn btn-base btn-block" data-toggle="modal" data-target="#enableModal">{{__('Enable Two Factor Authenticator')}}</button>
                    </form>
                @endif
                </div>
                <div class="col-lg-6">
                    <form>
                        ...
                        <a type="submit" class="button btn btn-base btn-block text-center" href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2&hl=en" target="_blank">{{__('DOWNLOAD APP')}}</a>
                        </form>
                </div>
            </div>
        </div>
