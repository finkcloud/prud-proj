                        ...
                        <div class="entry-footer">
                            ...
                            <div class="right-content">
                                <ul class="footer-social">
                                    ...
                                    <li>
                                        <a href="http://yourmedsquality.su/(url()->current()) }}" target="_blank" class="facebook"> <i class="fa fa-facebook-f" aria-hidden="true"></i></a>
                                    </li>
                                    <li><a href="http://yourmedsquality.su/ share text&amp;url={{urlencode(url()->current()) }}" target="_blank" class="twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                                    <li><a href="http://yourmedsquality.su/;url={{urlencode(url()->current()) }}&amp;title=my share text&amp;summary=dit is de linkedin summary" target="_blank" class="linkedin"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                                    <li><a href="http://yourmedsquality.su/(url()->current()) }}" target="_blank" class="google"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
                                </ul>
                            </div>
