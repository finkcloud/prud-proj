...
class ExpressCheckout
{
    ...
    {
        // $gateWay = PaymentGatway::first();
        // $credentials['sandbox']['username'] = $gateWay->gateway_key_one;
        // $credentials['sandbox']['password'] = $gateWay->gateway_key_two;
        // $credentials['sandbox']['secret'] = $gateWay->gateway_key_three;
        // $credentials['sandbox']['app_id'] = $gateWay->gateway_key_four;
